...
CREATE TABLE OPTIONS (
	...
	ID_ANSWER INTEGER UNSIGNED NOT NULL,
...
ALTER TABLE OPTIONS ADD CONSTRAINT FK_OPTIONS_TRUE_FALSE_ANSWERS 
	FOREIGN KEY (ID_ANSWER) REFERENCES TRUE_FALSE_ANSWERS (ID_ANSWER)
	ON DELETE CASCADE ON UPDATE CASCADE;
