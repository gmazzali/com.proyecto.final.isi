...
/**
 * La clase de prueba para las actividades en la ontología.
 * 
 * @author Guillermo Mazzali
 * @version 1.0
 */
public class ActivityRdfTestUnit {
	...
	/**
	 * Las pruebas sobre las actividades.
	 */
	@Test
	public void pruebaDeLasActividades() {
		
		System.out.println("######################################################################");
		System.out.println("###################### ACTIVIDADS EN ONTOLOGÍAS ######################");
		System.out.println("######################################################################");
		...
		HolderApplicationContext.getBean(ActivityRdf.class).createIndividual(ontology, activity1);
		HolderApplicationContext.getBean(ActivityRdf.class).createIndividual(ontology, activity2);
