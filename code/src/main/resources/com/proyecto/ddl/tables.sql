...
ALTER TABLE RULES_SETS ADD CONSTRAINT FK_RULES_SETS_SUBJECTS 
	FOREIGN KEY (ID_SUBJECT) REFERENCES SUBJECTS (ID_SUBJECT)
	ON DELETE CASCADE ON UPDATE CASCADE;	
...
CREATE TABLE ACTIVITIES (
	...
	DESCRIPTION TEXT NOT NULL,
	ACTIVE BOOL NOT NULL DEFAULT TRUE,
	ID_SUBJECT INTEGER UNSIGNED,
	PRIMARY KEY (ID_ACTIVITY),
	KEY (ID_SUBJECT)
);

ALTER TABLE ACTIVITIES ADD CONSTRAINT FK_ACTIVITIES_SUBJECTS 
	FOREIGN KEY (ID_SUBJECT) REFERENCES SUBJECTS (ID_SUBJECT)
	ON DELETE CASCADE ON UPDATE CASCADE;
	
	
############################################################
####### La tabla de relación de actividad y reactivo #######
############################################################
	
DROP TABLE IF EXISTS REACTIVES_IN_ACTIVITIES;

CREATE TABLE REACTIVES_IN_ACTIVITIES (
	ID_ACTIVITY INTEGER UNSIGNED NOT NULL,
	ID_REACTIVE INTEGER UNSIGNED NOT NULL,
	PRIMARY KEY (ID_ACTIVITY, ID_REACTIVE),
	KEY (ID_ACTIVITY),
	KEY (ID_REACTIVE)
);

ALTER TABLE REACTIVES_IN_ACTIVITIES ADD CONSTRAINT FK_REACTIVES_IN_ACTIVITIES_ACTIVITIES 
	FOREIGN KEY (ID_ACTIVITY) REFERENCES ACTIVITIES (ID_ACTIVITY)
	ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE REACTIVES_IN_ACTIVITIES ADD CONSTRAINT FK_REACTIVES_IN_ACTIVITIES_REACTIVES 
	FOREIGN KEY (ID_REACTIVE) REFERENCES REACTIVES (ID_REACTIVE)
	ON DELETE CASCADE ON UPDATE CASCADE;
...
CREATE TABLE ASSESSMENTS (
	ID_ASSESSMENT INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
	DESCRIPTION TEXT NOT NULL,
	ASSESSMENT_MOMENT VARCHAR(20) NOT NULL,
...
ALTER TABLE ASSESSMENTS ADD CONSTRAINT FK_ASSESSMENTS_SUBJECTS 
	FOREIGN KEY (ID_SUBJECT) REFERENCES SUBJECTS (ID_SUBJECT)
	ON DELETE CASCADE ON UPDATE CASCADE;


############################################################
#### La tabla de relación de evaluaciones y actividades ####
############################################################

DROP TABLE IF EXISTS ACTITITIES_IN_ASSESSMENTS;

CREATE TABLE ACTIVITIES_IN_ASSESSMENTS (
	ID_ASSESSMENT INTEGER UNSIGNED NOT NULL,
	ID_ACTIVITY INTEGER UNSIGNED NOT NULL,
	PRIMARY KEY (ID_ASSESSMENT, ID_ACTIVITY),
	KEY (ID_ACTIVITY),
	KEY (ID_ASSESSMENT)
);

ALTER TABLE ACTIVITIES_IN_ASSESSMENTS ADD CONSTRAINT FK_ACTIVITIES_IN_ASSESSMENTS_ACTIVITIES 
	FOREIGN KEY (ID_ACTIVITY) REFERENCES ACTIVITIES (ID_ACTIVITY)
	ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE ACTIVITIES_IN_ASSESSMENTS ADD CONSTRAINT FK_ACTIVITIES_IN_ASSESSMENTS_ASSESSMENTS 
