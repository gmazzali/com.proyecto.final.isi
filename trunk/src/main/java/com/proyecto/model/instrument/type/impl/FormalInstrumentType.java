...
public enum FormalInstrumentType implements InstrumentTypeInterface {
	 ...
	 */
	OBJETIVE_ACTIVITY(1, "Objetive activity", ObjectiveActivityInstrument.class, ObjectiveInstrumentType.values()),
	/**
	 * El elemento de los instrumentos formales de ensayos.
	 */
	ESSAY_ACTIVITY(2, "Essay activity", EssayActivityInstrument.class, EssayInstrumentType.values());
