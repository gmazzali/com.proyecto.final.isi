...
public class CompletionInstrumentFormDialog extends InstrumentFormDialog {
	...
	/**
	 * El conjunto de las palabras que tenemos para agregar a los lugares faltantes de la descripci�n del instrumento.
	 */
	...
	/**
	 * El constructor por omisi�n de la ventana.
	 */
	...
	/**
	 * La funci�n que inicializa la ventana.
	 */
	private void init() {
	...
	/**
	 * La funci�n encargada de agregar una frase a la lista de frases para completar.
	 */
	...
	/**
	 * La funci�n encargada de vaciar los campos correspondientes a las frases para completar.
	 */
