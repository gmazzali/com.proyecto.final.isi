...
public abstract class BaseListDialog<E extends Persistence<?>> extends JDialog {
	...
	/**
	 * La funci�n que vamos a ejecutar antes de comenzar con el proceso en segundo plano.
	 */
	protected abstract void afterProccess();

	/**
	 * La funci�n que vamos a ejecutar despu�s de terminar con el proceso en segundo plano o despu�s que el mismo se detuvo.
	 */
	protected abstract void beforeProccess();

	/**
	 * La funci�n que arranca el proceso de llenado de la lista en segundo plano.
	 */
	...
	/**
	 * La funci�n que para el proceso de llenado de la lista en segundo plano.
	 */
	...
	/**
	 * La funci�n encargada de inicializar el proceso de llenado de entidades dentro de la lista de la ventana.
	 */
	...
	/**
	 * La funci�n que define el proceso de carga de la lista que vamos a ejecutar en segundo plano dentro de este dialogo.
	 * 
	...
	/**
	 * La funci�n que arranca el proceso de borrado de una entidad en segundo plano.
	 * 
	 * @param entity
	...
	/**
	 * La funci�n que para el proceso de borrado de la entidad en segundo plano.
	 */
	...
	/**
	 * La funci�n encargada de inicializar el proceso de borrado de una entidad dentro de la lista de la ventana.
	 * 
	 * @param entity
	 *            La entidad que vamos a borrar.
	 */
	...
	/**
	 * La funci�n que define el proceso de borrado de entidades que vamos a ejecutar en segundo plano dentro de este dialogo.
	 * 
	 * @param entity
	 *            La entidad que vamos a borrar.
	 * @throws CheckedException
