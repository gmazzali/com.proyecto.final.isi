...
CREATE TABLE ACTITITIES_IN_ASSESSMENTS (
...
ALTER TABLE ACTITITIES_IN_ASSESSMENTS ADD CONSTRAINT FK_ACTITITIES_IN_ASSESSMENTS_ACTIVITIES 
	FOREIGN KEY (ID_ACTIVITY) REFERENCES ACTIVITIES (ID_ACTIVITY)
	ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE ACTITITIES_IN_ASSESSMENTS ADD CONSTRAINT FK_ACTITITIES_IN_ASSESSMENTS_ASSESSMENTS 
