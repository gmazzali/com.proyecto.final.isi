...
public class ActivityFactoryRdfTestUnit {
	...
	public void pruebaDeLaFactoriaDeLasActividades() {
		...
		HolderApplicationContext.getBean(ActivityFactoryRdf.class).loadInstrumentToOntology(ontology, activity1);
		HolderApplicationContext.getBean(ActivityFactoryRdf.class).loadInstrumentToOntology(ontology, activity2);
